...
const Firstsection = () => {
  return (
    <main>
      <section>
        <h3>What we do</h3>
        <h2>We've got everything you need to launch and grow you business</h2>
      </section>
      ...
      <section>
        ...
        <article>
          <svg
            ...
            viewBox="0 0 640 640"
          >
            <path d="M412.812 528.692l-23.516 41.162-128.86-63.568 4.43-44.233 147.946 66.639zM129.58 255.736H0v149.648h129.58V255.736zm61.69 173.175l-9.662 96.58 242.105 119.435 50.6-88.537 165.686 74.612V-4.936l-487.447 258.25v158.164l38.717 17.433z" />
          </svg>
          <div>
            <h3>Marketing</h3>
            <p>
